...
def add_pemola_config(cfg):
    cfg.MODEL.PEMOLA = CN()
    cfg.MODEL.PEMOLA.PE_MODULATION = False
    cfg.MODEL.PEMOLA.CAM_ONLY = False
    cfg.MODEL.PEMOLA.EMBED_ONLY = False
    cfg.MODEL.PEMOLA.VIS_PE = False
    # Feature levels at which to save PE visualizations. Must be subset of
    # SEM_SEG_HEAD.DEFORMABLE_TRANSFORMER_ENCODER_IN_FEATURES.
